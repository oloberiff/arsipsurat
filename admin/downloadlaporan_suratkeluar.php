...
// Set properties
$excelku->getProperties()->setCreator("Farmasi")
                         ->setLastModifiedBy("Farmasi");
...
$excelku->getActiveSheet()->setCellValue('A2', "KEMENTERIAN PENDIDIKAN DAN KEBUDAYAAN");
$excelku->getActiveSheet()->mergeCells('A3:H3');
$excelku->getActiveSheet()->setCellValue('A3', "UNIVERSITAS MULAWARMAN");
$excelku->getActiveSheet()->mergeCells('A4:H4');
$excelku->getActiveSheet()->setCellValue('A4', "FAKULTAS FARMASI");
$excelku->getActiveSheet()->mergeCells('A5:H5');
$excelku->getActiveSheet()->setCellValue('A5', "Jl. Penajam, Kota Samarinda, Kalimantan Timur ");
