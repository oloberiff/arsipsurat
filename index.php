...
<html lang="en">
  <head>
    ...
    <title>Arsip Surat Fakultas Farmasi</title>
  ...
  <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">Fakultas Farmasi</span></a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <div class="logo">
		            <img src="img/unmul.png" style="width: 150px" alt="" />
	            </div>
              <h3 class="bnr-sub-title">SISTEM INFORMASI PENGARSIPAN SURAT</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">FAKULTAS FARMASI UNIVERSITAS MULAWARMAN</span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini membantu menyimpan dan melakukan pencatatan arsip surat masuk ataupun surat keluar secara digital</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
    ...
    <!---->
    <!---->
    <!-- //section ini untuk membuat slide testimoni dll
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; Fakultas Farmasi. All Rights Reserved.</p>
          <div class="credits">
            <!-- 
